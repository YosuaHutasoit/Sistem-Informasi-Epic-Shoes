        ...
        <div class="container-fluid">
            <div class="row mt-5">
                ...
                <div class="col-md-8">
                    ...
                    <h3 class="mb-4">Input Alamat dan Pembayaran</h3>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <Input type="text" name="no_telpon" placeholder="Nomor Telepon Anda" class="form-control" ></Input>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select class="form-control">
                            ...
                            <option>Bank BTN - XXXXXXX</option>
                            <option>Bank Jago - XXXXXXX</option>
                        </select>
                    </div>
