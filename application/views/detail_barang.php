    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <?php foreach($barang as $brg): ?>
                <div class="row">
                    <div class="col-md-4">
                        <img src="<?php echo base_url().'/uploads/'.$brg->gambar ?>" class="card-img-top" alt="gambar produk">
                    </div>
                    <div class="col-md-8 mt-5">
                        <table class="table">
                            <tr>
                                <td><strong>Nama Produk</strong></h5></td>
                                <td><?php echo $brg->nama_sepatu ?></h5></td>
                            </tr>

                            <tr>
                                <td><strong>Keterangan</strong></h5></td>
                                <td><?php echo $brg->keterangan ?></h5></td>
                            </tr>

                            <tr>
                                <td><strong>Kategori</strong></h5></td>
                                <td><?php echo $brg->kategori ?></h5></td>
                            </tr>

                            <tr>
                                <td><strong>Stok</strong></h5></td>
                                <td><?php echo $brg->stok ?></h5></td>
                            </tr>

                            <tr>
                                <td><strong>Harga</strong></h5></td>
                                <td>Rp. <?php echo number_format($brg->harga, 0,',','.' ) ?> </div></h3></td>
                            </tr>
