            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6  d-none d-lg-block "><img src="<?php echo base_url() ?>assets/img/login.png" alt=""  ></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url('registrasi/index'); ?>">Belum Mempunyai Akun? Daftar! </a>
                                    </div>
                                </div>
                            </div>
                        </div>
